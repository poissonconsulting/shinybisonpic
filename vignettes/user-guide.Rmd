...
- Click the **Download Plot** button to get a PNG file (shinybisonpic_ratio_plot.png) of the plot
...
- Click **Download Clean Data** button to get an excel file
  - The file name have the format YYYY-MM-DD_HH-MM-SS_bison_data.xlsx
