...
```
*<font size="-1">Figure 5. Example of the Map Locations tab showing the points of each camera trap on the map. Location LOCID11 has been selected in the drop-down menu so is highlighted in yellow. 
