...
Explore the ratios (numerator/numerator + denominator) of various sex-age groups by selecting any combinations of values.
...
Get data that is ready to be fed into the modeling app.
